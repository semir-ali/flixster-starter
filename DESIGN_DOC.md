...
### Phase 1: MVP (Due June 16, 2026)

**Day 1 (June 14):**
- ✅ Project setup (fork, clone, npm install)
- ✅ Write `planning.md` (all 5 sections)
- ✅ Obtain TMDb and OpenRouter API keys, add to `.env`
- ✅ Create component files (App, Header, Footer, MovieCard, MovieList, SearchBar, SortDropdown, LoadMoreButton, MovieModal)
...
**Day 2 (June 15):**
- Implement SearchBar (controlled input)
- Implement search functionality
- Implement Load More pagination
- Implement toggle between Now Playing/Search
- Implement SortDropdown
- Build MovieModal (fetch details)
- Implement AI recommendation in modal
- Build Header and Footer
- Commit progress

**Day 3 (June 16 - Deadline):**
- Implement responsive grid (media queries)
- Style all components (colors, typography, spacing, shadows, hover states)
- Verify accessibility (alt text, contrast, keyboard nav, semantic HTML)
- Test all features (search, sort, pagination, modal, AI)
...
- Build SearchPage (move existing code)
- Build FavoritesPage and WatchedPage
- Implement Favorites system (localStorage)
- Implement Watched system (localStorage)
- Add favorite/watched buttons to MovieCards
- Commit progress

**Week 3 (June 22-26):**
- Build genre onboarding modal
- Fetch genre list from TMDb
- Save user preferences to localStorage
- Build HomePage with CategorySection components
- Implement section generation logic (8 sections)
- Fetch data for each section (Now Playing, Top Rated, Similar, Genres)
- Build MovieCarousel component (horizontal scroll)
- Test recommendation system
- Commit progress

**Week 4 (June 27+):**
- Implement trailer fetching
- Embed YouTube trailers in modal
- Deploy to Render
...
**Why**: API keys in `.env` must NEVER be committed to GitHub. Anyone with access to your repo could steal and abuse your keys.
...
- **Browser-side API keys are inherently insecure**: Keys are visible in browser DevTools network requests
- **Acceptable for development**: Using free-tier APIs for a learning project
- **Production solution**: Move API calls to a backend server (Node.js/Express) to hide keys
...
- **Start with `planning.md`**: Don't skip this. It will save you hours of confusion later.
